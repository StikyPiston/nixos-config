...

{
  ...
  xdg.configFile."helix/config.toml".text = ''
    ...
    [keys.normal." "]
    "l" = { "g" = [ ":write-all", ":new", ":insert-output lazygit", ":buffer-close!", ":redraw", ":reload-all" ], "f" = ":format"}
    "w" = ":write"
    "q" = ":quit"
  ...
  xdg.configFile."helix/languages.toml".text = ''
    [[language]]
    name = "markdown"
    language-servers = [ "uwu-colors", "markdown-oxide" ]
  ...
  xdg.configFile."helix/themes/catppuccin_mocha.toml".text = ''
    ...
    # Inline annotations
    # ------------------
    "important"  = { bg = "maroon", fg = "black", modifiers = ["bold"] }
    "question"   = { bg = "peach",  fg = "black", modifiers = ["bold"] }
    "study"      = { bg = "blue",   fg = "black", modifiers = ["bold"] }
    "definition" = { bg = "mauve",  fg = "black", modifiers = ["bold"] }
    "example"    = { bg = "green",  fg = "black", modifiers = ["bold"] }
    "review"     = { bg = "peach",  fg = "black", modifiers = ["bold"] }
    "memorise"   = { bg = "pink",   fg = "black", modifiers = ["bold"] }

    # User Interface
    # --------------
    "ui.background" = { fg = "text", bg = "" }
    ...
    "ui.statusline.normal" = { fg = "base", bg = "mauve", modifiers = ["bold"] }
  ...
  '';
  xdg.configFile."helix/runtime/queries/markdown/highlights.scm".text = ''
